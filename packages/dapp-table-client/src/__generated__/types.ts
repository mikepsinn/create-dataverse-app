...
export type GetFileSystemModelsQuery = {
  __typename?: "RootQuery";
  getFileSystemModels: Array<string>;
};
...
export function getSdk(
  ...
  return {
    CreateDapp(
      variables: CreateDappMutationVariables,
      requestHeaders?: GraphQLClientRequestHeaders,
    ): Promise<CreateDappMutation> {
      return withWrapper(
        wrappedRequestHeaders =>
          client.request<CreateDappMutation>(CreateDappDocument, variables, {
            ...requestHeaders,
            ...wrappedRequestHeaders,
          }),
        "CreateDapp",
    ...
    UpdateDapp(
      variables: UpdateDappMutationVariables,
      requestHeaders?: GraphQLClientRequestHeaders,
    ): Promise<UpdateDappMutation> {
      return withWrapper(
        wrappedRequestHeaders =>
          client.request<UpdateDappMutation>(UpdateDappDocument, variables, {
            ...requestHeaders,
            ...wrappedRequestHeaders,
          }),
        "UpdateDapp",
    ...
    GetFileSystemModels(
      variables?: GetFileSystemModelsQueryVariables,
      requestHeaders?: GraphQLClientRequestHeaders,
    ): Promise<GetFileSystemModelsQuery> {
      return withWrapper(
        wrappedRequestHeaders =>
          client.request<GetFileSystemModelsQuery>(
            GetFileSystemModelsDocument,
            variables,
    ...
    GetDapps(
      variables?: GetDappsQueryVariables,
      requestHeaders?: GraphQLClientRequestHeaders,
    ): Promise<GetDappsQuery> {
      return withWrapper(
        wrappedRequestHeaders =>
          client.request<GetDappsQuery>(GetDappsDocument, variables, {
            ...requestHeaders,
            ...wrappedRequestHeaders,
          }),
        "GetDapps",
    ...
    GetDapp(
      variables: GetDappQueryVariables,
      requestHeaders?: GraphQLClientRequestHeaders,
    ): Promise<GetDappQuery> {
      return withWrapper(
        wrappedRequestHeaders =>
          client.request<GetDappQuery>(GetDappDocument, variables, {
            ...requestHeaders,
            ...wrappedRequestHeaders,
          }),
        "GetDapp",
